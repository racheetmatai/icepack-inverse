#!/usr/bin/env python3
"""Verify a copied production preflight manifest and every declared output."""
...
manifest = json.loads((root / "preflight_manifest.json").read_text(encoding="utf-8"))
...
raise SystemExit(
    ...
    and not bad_outputs
    and result["hard_failure_count"] == 0
    else 1
)
